<?php
/**
 * Anva Framework is a WordPress theme development framework. The framework allows developers
 * to quickly build themes without having to handle all of the "logic" behind the theme or having to
 * code complex functionality for features that are often needed in themes.
 *
